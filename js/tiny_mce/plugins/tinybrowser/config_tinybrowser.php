...
$tinybrowser['path']['image'] = '/blogs/img_upload/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/blogs/img_upload/'; // Media files location
$tinybrowser['path']['file']  = '/blogs/img_upload/'; // Other files location
