...
<form id="back_form_category" class="add_new_topic" action='<?php echo base_url()?>backend/sale_category_save' method='post' name='edit_text' enctype='multipart/form-data'>
    <p><b>Название:</b></p>
