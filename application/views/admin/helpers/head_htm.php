...
<script  type="text/javascript" src="<?php echo base_url();?>js/back.js"></script>


<script  type="text/javascript" src="<?php echo base_url();?>js/spring/modules/tinymce_init.js"></script>
