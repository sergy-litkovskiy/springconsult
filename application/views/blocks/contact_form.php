    ...
    <form id="contact_form" action='#' method='post' name='add_new' enctype='multipart/form-data'>
        <table class="contact" style='width:660px'>
            <tr>
                ...
                <td>
                    <input style='width:40%' id='name' name='name' value="<?php echo set_value('name', $contact_form['name']);?>"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input style='width:40%' id='email' name='email' value="<?php echo set_value('email', $contact_form['email']);?>"/>
                </td>
            </tr>
            <tr>
                <td>
