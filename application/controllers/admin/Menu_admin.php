...
//---------------------------------------------------------------
    function index()
    {
       ...
       $data = array(
                ...
                'content' => $this->load->view('admin/menu_admin/show', $this->data_arr, true));
...
//---------------------------------------------------------------
    function edit_menu_item($itemId = null)
    {
        ...
        $data = array(
                ...
                'content' => $this->load->view('admin/menu_admin/item_edit', $this->data_arr, true));
...
//---------------------------------------------------------------
    function edit_menu_subitem($subItemId = null)
    {
        ...
        $data = array(
                'menu'    => $this->load->view(MENU_ADMIN, '', true),
                'content' => $this->load->view('admin/menu_admin/subitem_edit', $this->data_arr, true));
